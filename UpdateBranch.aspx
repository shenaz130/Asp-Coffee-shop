<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateBranch.aspx.cs" Inherits="UpdateBranch" %>
        ...
        <div style="background-color: #99FF99; width: 1346px; height: 705px;">
            <div id="nav" style="background-color: #009933; height: 124px;">
                ...
                <asp:ImageButton ID="ImageButtonOption" runat="server" Height="51px" ImageUrl="~/NewFolder1/New folder (2)/options button.png" Width="64px" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:ImageButton ID="ImageButtonHome" runat="server" Height="49px" ImageUrl="~/NewFolder1/New folder (2)/home button'.png" Width="60px" OnClick="ImageButtonHome_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;<div class="view" style="background-color:#99FF99; height: 450px; margin-left: 40px; width: 450px;" id="view">
